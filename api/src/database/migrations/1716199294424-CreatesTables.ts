...
export class CreatesTables1716199294424 implements MigrationInterface {
  name = 'CreatesTables1716199294424'

  public async up (queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "easyinventory"."sale_status_enum" AS ENUM('ongoing', 'closed')`)
    await queryRunner.query(`CREATE TABLE "easyinventory"."sale" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "saleDate" TIMESTAMP NOT NULL, "status" "easyinventory"."sale_status_enum" NOT NULL DEFAULT 'ongoing', CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE "easyinventory"."paiementmethod" ("id" SERIAL NOT NULL, "label" character varying NOT NULL, CONSTRAINT "PK_51919fac34d78a18908b2633378" PRIMARY KEY ("id"))`)
    await queryRunner.query(`CREATE TABLE "easyinventory"."saleline" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "saleid" integer NOT NULL, "articleid" integer NOT NULL, "quantity" integer NOT NULL, "saleprice" numeric(10,2) NOT NULL, "paiementmethodid" integer NOT NULL, CONSTRAINT "PK_a1ce7fada72dbc025aa35fb3be1" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."saleline" ADD CONSTRAINT "FK_55e5f40fe400789802e21450803" FOREIGN KEY ("paiementmethodid") REFERENCES "easyinventory"."paiementmethod"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."saleline" DROP CONSTRAINT "FK_55e5f40fe400789802e21450803"`)
    ...
    await queryRunner.query(`DROP TABLE "easyinventory"."paiementmethod"`)
    ...
    await queryRunner.query(`DROP TYPE "easyinventory"."sale_status_enum"`)
  }
