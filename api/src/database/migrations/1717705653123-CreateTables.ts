...
export class CreateTables1717705653123 implements MigrationInterface {
  name = 'CreateTables1717705653123'

  public async up (queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "easyinventory"."paymentmethod" ("id" SERIAL NOT NULL, "label" character varying NOT NULL, CONSTRAINT "PK_ec36b4a8cd74bd602f3f9e9e109" PRIMARY KEY ("id"))`)
    await queryRunner.query(`CREATE TABLE "easyinventory"."payment" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "saleid" integer NOT NULL, "amount" integer NOT NULL, "paymentmethodid" integer NOT NULL, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE "easyinventory"."saleline" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "saleid" integer NOT NULL, "articleid" integer NOT NULL, "quantity" integer NOT NULL, "saleprice" numeric(10,2) NOT NULL, CONSTRAINT "PK_a1ce7fada72dbc025aa35fb3be1" PRIMARY KEY ("id"))`)
    await queryRunner.query(`CREATE TABLE "easyinventory"."sale" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "salesessionid" integer NOT NULL, "totalAmount" integer NOT NULL, "saleSessionId" integer, CONSTRAINT "PK_d03891c457cbcd22974732b5de2" PRIMARY KEY ("id"))`)
    await queryRunner.query(`CREATE TYPE "easyinventory"."salesession_status_enum" AS ENUM('ongoing', 'closed')`)
    await queryRunner.query(`CREATE TABLE "easyinventory"."salesession" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "status" "easyinventory"."salesession_status_enum" NOT NULL DEFAULT 'ongoing', CONSTRAINT "PK_9e2eb5e78863116713d5bb7f9ee" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE "easyinventory"."inventorytype" ("id" SERIAL NOT NULL, "label" character varying NOT NULL, CONSTRAINT "PK_a60db32833059c22f3f741729fa" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE "easyinventory"."invenotryline" ("id" SERIAL NOT NULL, "creationdate" TIMESTAMP NOT NULL DEFAULT now(), "updatedate" TIMESTAMP NOT NULL DEFAULT now(), "deletedate" TIMESTAMP, "articleId" integer NOT NULL, "inventoryid" integer NOT NULL, "quantity" integer NOT NULL, CONSTRAINT "PK_876ed3fe70f18de3cd098f10b9f" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`CREATE TABLE "easyinventory"."movementtype" ("id" SERIAL NOT NULL, "label" character varying NOT NULL, "isinternal" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_c01495a41425fe7dba9ec0d0d16" PRIMARY KEY ("id"))`)
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."payment" ADD CONSTRAINT "FK_0d6a48e8c10a56205f82dac87c2" FOREIGN KEY ("paymentmethodid") REFERENCES "easyinventory"."paymentmethod"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await queryRunner.query(`ALTER TABLE "easyinventory"."payment" ADD CONSTRAINT "FK_f1dd6480ee16924e68662fab123" FOREIGN KEY ("saleid") REFERENCES "easyinventory"."sale"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."saleline" ADD CONSTRAINT "FK_71765c71ada755357ab3ad35b0c" FOREIGN KEY ("articleid") REFERENCES "easyinventory"."article"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."invenotryline" ADD CONSTRAINT "FK_33b73cc50acff642ee934c0b928" FOREIGN KEY ("articleId") REFERENCES "easyinventory"."article"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."inventory" ADD CONSTRAINT "FK_b3b840ea9f1afd2bc7582b38cf2" FOREIGN KEY ("inventorytypeid") REFERENCES "easyinventory"."inventorytype"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."invenotryline" DROP CONSTRAINT "FK_33b73cc50acff642ee934c0b928"`)
    ...
    await queryRunner.query(`ALTER TABLE "easyinventory"."saleline" DROP CONSTRAINT "FK_71765c71ada755357ab3ad35b0c"`)
    await queryRunner.query(`ALTER TABLE "easyinventory"."article" DROP CONSTRAINT "FK_161bfd30037ed15240f5808af4d"`)
    await queryRunner.query(`ALTER TABLE "easyinventory"."payment" DROP CONSTRAINT "FK_f1dd6480ee16924e68662fab123"`)
    await queryRunner.query(`ALTER TABLE "easyinventory"."payment" DROP CONSTRAINT "FK_0d6a48e8c10a56205f82dac87c2"`)
    ...
    await queryRunner.query(`DROP TABLE "easyinventory"."inventorytype"`)
    await queryRunner.query(`DROP TABLE "easyinventory"."user"`)
    await queryRunner.query(`DROP TABLE "easyinventory"."salesession"`)
    await queryRunner.query(`DROP TYPE "easyinventory"."salesession_status_enum"`)
    ...
    await queryRunner.query(`DROP TABLE "easyinventory"."payment"`)
    await queryRunner.query(`DROP TABLE "easyinventory"."paymentmethod"`)
  }
